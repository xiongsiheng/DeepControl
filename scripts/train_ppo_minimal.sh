...
export WAND_PROJECT='DeepControl-PPO_nq_hotpotqa_search_soft_em_minimal'

# base model
export BASE_MODEL='Qwen/Qwen2.5-3B-Instruct'

export NOW=$(date +"%Y%m%d_%H%M%S")
export EXPERIMENT_NAME=nq_hotpotqa_search-deepcontrol-ppo-qwen2.5-3b-it-minimal_${NOW}

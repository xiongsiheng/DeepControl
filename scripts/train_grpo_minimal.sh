...
export WAND_PROJECT='DeepControl-GRPO_nq_hotpotqa_search_soft_em_minimal'

# base model
export BASE_MODEL='Qwen/Qwen2.5-3B-Instruct'

export NOW=$(date +"%Y%m%d_%H%M%S")
export EXPERIMENT_NAME=nq_hotpotqa_search-deepcontrol-grpo-qwen2.5-3b-it-minimal_${NOW}
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    retriever.topk=5 \
    do_search=true \
    enable_utility_controller=false \
